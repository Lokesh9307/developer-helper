...
const Sidebar = () => {
  ...
  return (
    <div className='lg:w-[20%] w-full lg:h-screen h-20 lg:py-6 pl-6 flex lg:flex-col flex-row lg:gap-3 gap-2 bg-secondarybg rounded-2xl text-textColor duration-500 lg:px-1 px-2 lg:overflow-hidden overflow-x-scroll lg:justify-start justify-between'>
      {
